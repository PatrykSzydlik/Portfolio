...
protected:
         ...
         */
        bool AreErrorMessagesDisplayed() const {
                return display_error_messages_;
        }
        /*!
...
public:
         ...
         * \retval false - w przypadku przeciwnym.
         */
        bool show_OX_axis() const {
                return show_OX_axis_;
        }
         ...
         * \retval false - w przypadku przeciwnym.
         */
        bool show_OY_axis() const {
                return show_OY_axis_;
        }
         ...
         * \retval false - w przypadku przeciwnym.
         */
        bool show_OZ_axis() const {
                return show_OZ_axis_;
        }
         ...
         *        \link GnuplotLink::AddFilename AddFilename\endlink.
