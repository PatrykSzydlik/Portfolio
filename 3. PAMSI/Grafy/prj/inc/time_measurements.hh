...
/*!
\brief Funkcja zwracająca zmierzony czasu w ms
\param[out] - ilość czasu w milisekundach
*/
    float ms(){
        float time_in_ms =useconds/1000 + mseconds + seconds*1000 + minutes*60000 + hours*3600000;
        return time_in_ms;
...
/*!
\brief Funkcja zwracająca zmierzony czasu w us
\param[out] - ilość czasu w mikrosekundach
*/
    float us(){
        float time_in_us =useconds + mseconds*1000 + seconds*1000000 + minutes*60000000 + hours*3600000000;
        return time_in_us;
    }
/*!
